...
//            System.getProperty("user.dir") + "/src/main/resources/web_drivers/chromedriver.exe";
    ...
    private static WebDriver getWebDriver() {
        try {
            ...
            // 设置窗口大小
            options.addArguments(String.format("--width=%d", DEFAULT_WIDTH));
            options.addArguments(String.format("--height=%d", DEFAULT_HEIGHT));
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "初始化 Firefox 浏览器失败: " + e.getMessage());
        }
    }
    /**
     * 保存图片到文件
